...
export default function ChatPage() {
  ...
  return (
    <ChatProvider initialUrlUserId={searchParams.get("userId")}>
      <div className="relative flex min-h-[calc(100vh-64px)] overflow-hidden bg-gray-100">
        {/* Mobile menu button */}
        {isMobile && (
          <button
        ...
        <div
          className={`${sidebarOpen ? "translate-x-0" : "-translate-x-full"} 
            ...
            fixed md:relative z-40 md:z-auto w-80 md:w-1/3 lg:w-1/4 h-[calc(100vh-64px)]`}
        >
          <ChatSidebar />
        </div>
